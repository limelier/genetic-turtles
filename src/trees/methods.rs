...
impl Node {
    ...
    pub fn children(&self) -> Vec<&Node> {
        match self {
            Print(c1) | Unary(_, c1) | Store(_, c1) => vec![c1],

            Binary(_, c1, c2) | While(c1, c2) | Compare(c1, c2) | Repeat(c1, c2) | Then(c1, c2) => {
                vec![c1, c2]
            }

            If(c1, c2, c3) => vec![c1, c2, c3],
...
mod tests {
    use super::*;
    use crate::vm::definitions::{BinaryOperation, Source};
